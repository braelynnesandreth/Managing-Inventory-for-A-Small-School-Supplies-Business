...
{
    /// <inheritdoc />
    public partial class AddedAllClasses_16Dec2024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    StaffId = table.Column<int>(type: "int", nullable: false),
                    StaffId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SmallBusinessOwnerId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.SmallBusinessOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RestockOrderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SupplierID = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestockOrder", x => x.RestockOrderId);
                    table.ForeignKey(
                        name: "FK_RestockOrder_AspNetUsers_SmallBusinessOwnerId",
                        column: x => x.SmallBusinessOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestockOrder_SmallBusinessOwnerId",
                table: "RestockOrder",
                column: "SmallBusinessOwnerId");
