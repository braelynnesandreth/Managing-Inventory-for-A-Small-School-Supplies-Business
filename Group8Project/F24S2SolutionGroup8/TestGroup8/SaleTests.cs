...
namespace TestGroup8
{
    ...
    public void SearchSalesByProductName_ShouldReturnMatchingSales()
    {
        ...
        [Fact]
        public void CalculateTotal_ShouldReturnZero_WhenNoSaleDetails()
        {
            // Arrange
            var sale = new Sale { SaleDetail = new List<SaleDetail>() };
        ...
        [Fact]
        public void SearchSalesByProductName_ShouldReturnEmpty_WhenNoMatchingProducts()
        {
            // Arrange
            var product1 = new Product { Name = "Notebook" };
            var product2 = new Product { Name = "Pen" };
            ...
            // Act
            var result = sale.SearchSalesByProductName("Eraser");
